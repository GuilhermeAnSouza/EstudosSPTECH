...
select a.nome, ifnull(c.nome,'aluno Não alocado') as 'NOME CASA', a.jogador, ifnull(a.pet,'nenhum pet') AS PET, ifnull(a.patrono,'sem memorias felizes') as patrono from alunos as a
	left join casaHogwarts as c
		on a.fkCasa = c.idCasa;
